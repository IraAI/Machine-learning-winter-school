...
feature_histogram1 = compute_lr_histogram(initials(1), Alphabet, images, labels, num_bins)
feature_histogram2 = compute_lr_histogram(initials(2), Alphabet, images, labels, num_bins)
